...
- Multi-Agent coordination contracts and client identity support are coded on the coordinator branch. The compatibility documentation now defines generic stdio MCP setup, explicit tab targeting, leases, bounded conflict handling, recorder exclusivity, and quarantine behavior. This documentation task has not performed a real Chrome verification.
